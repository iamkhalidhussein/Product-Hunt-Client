        ...
        <div className="md:flex justify-center">
            <div className='border rounded-lg mr-3'>
                <div className='p-5 pl-6'>
                    <img className='w-96 h-56 border rounded-md' 
                        src={image} 
                        alt="#" 
                    />
                </div>
                ...
                <div className='flex gap-0 justify-between py-5 px-5'>
                    <div 
                        ...
                        className='flex gap-2 border px-4 py-2 cursor-pointer rounded-[5px] border-[#6A6EF8] items-center text-[#6A6EF8] text-base inter font-medium '>
                        <img 
                            className='' 
                            src={upvotee} 
                            alt="#" 
                    ...
                    <div 
                        className='flex items-center text-[#79808A] cursor-pointer text-base inter font-medium hover:text-[#6A6EF8] duration-200'>
