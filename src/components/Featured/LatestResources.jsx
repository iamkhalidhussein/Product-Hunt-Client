        ...
        <div className="flex justify-center">
            <div className='border rounded-lg'>
                            ...
                            <div className='flex gap-[175px] py-5 px-5'>
                                <div className='flex gap-2 border px-4 py-2 cursor-pointer rounded-[5px] border-[#6A6EF8] items-center text-[#6A6EF8] text-base inter font-medium '><img className='' src={upvotee} alt="#" />Upvote<span>{upvote}</span></div>
