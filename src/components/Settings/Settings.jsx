            ...
            <div className="flex gap-10">
                ...
                <div className="bg-white py-9 h-full px-10 border rounded">
                    ...
                    <div className="flex justify-center">
                        <button className="bg-[#686EF8] py-3 px-6 rounded text-white">Change & Save</button>
                    </div>
                </div>
                ...
                <div className="border bg-white py-12 px-10">
                    <form>
                        ...
                        <input 
                            className="border bg-white mt-1 mb-3 pr-36 py-2.5 rounded pl-4" 
                            type="text" 
                            name="" 
                            id="" 
                            placeholder="Md Khalid"
                        /> <br />
                        ...
                        /> <br />
                        <input 
                            className="bg-[#686EF8] py-3 cursor-pointer text-white mt-6 px-6 rounded" 
                            type="submit" 
                            value="Save Now" 
                        />
                    </form>
