        ...
        <div>
            ...
            <div className='flex mt-14 border items-start justify-between pl-5 pr-5 rounded-lg py-10 bg-white'>
                    ...
                    <div className='border flex justify-start gap-3 p-4 rounded bg-white'>
                        <div onClick={approved}><button id="approved-btn" className='bg-[#2C3743] py-2.5 px-6 text-white rounded'>Approved</button></div>
                        <div onClick={underReview}><button id="underReview-btn" className='bg-[#686EF8] px-5 py-2.5 rounded text-white'>Under Review</button></div>
                        <div onClick={rejected}><button id="rejected-btn" className='bg-[#2C3743] px-5 py-2.5 text-white rounded'>Rejected</button></div>
                    </div>
                    <div id="approved" className="hidden">
                        <p>approved</p>
