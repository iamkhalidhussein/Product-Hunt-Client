...
const PaymentSuccess = () => {
    ...
    return (
        ...
        <div className="border md:w-2/5 w-4/5 mx-auto pt-5 pb-5 rounded-2xl px-10 bg-white dark:bg-gray-200">
            ...
            <h3 className="text-center pt-3 dark:text-black">Payment Success!</h3>
            <h2 className="text-[#121212] poppins dark:text-black text-[30px] pt-1 pb-7 text-center font-semibold">{currency_type} {amount}</h2>
