        ...
        <Navbar></Navbar>
            ...
            <div className='border z-0 sticky left-0 top-0 h-full  overflow-y-auto bg-white text-[#1B2430] ml-10 mt-14 text-[18px] rounded-lg py-7 pl-8 pr-8'>
...

                {
                    ...
                    <Link to="/dashboard/addProductPage" className={`flex gap-2 py-3 rounded-md pl-4 hover:bg-[#686EF8] hover:text-white duration-200 mb-1 cursor-pointer pr-56 items-center ${activeRoute === '/dashboard/submissions' ? 'bg-[#686EF8] text-white' : null}`}><RxPlus className='text-xl'/><span>Add Product</span></Link>
                    <Link to="/dashboard/userMyProducts" className={`flex gap-2 py-3 rounded-md pl-4 hover:bg-[#686EF8] hover:text-white duration-200 mb-1 cursor-pointer pr-56 items-center ${activeRoute === '/dashboard/upvotes' ? 'bg-[#686EF8] text-white' : null}`}><AiFillProduct className='text-xl'/><span>My Products</span></Link>
                    <Link to="/dashboard/settings" className={`flex gap-2 py-3 rounded-md pl-4 hover:bg-[#686EF8] hover:text-white duration-200 mb-1 cursor-pointer pr-56 items-center ${activeRoute === '/dashboard/settings' ? 'bg-[#686EF8] text-white' : null}`}><IoSettingsOutline className='text-xl'/><span>Settings</span></Link>
                    <div className='flex rounded-md bg-[#F5F8F9] mt-10 p-3 gap-2'>
                        <img className='w-[60px] h-[60px] rounded-full' src={user.photoURL} alt="#" />
                        <div>
