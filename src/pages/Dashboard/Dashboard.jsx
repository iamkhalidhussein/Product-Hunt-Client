...
const Dashboard = () => {
    ...
    return (
        <div className="flex gap-12 bg-[#F5F8F9] pt-32 border-t-[1px]">
            <div className='border z-0 sticky left-0 top-0  overflow-y-auto bg-white text-[#1B2430] ml-10 mt-14 text-[18px] rounded-lg py-7 pl-8 pr-8'>
            ...
            <div className='border w-3/5 pr-10'>
                    <div className='flex mt-14 border items-start justify-between pl-5 pr-5 rounded-lg py-10 bg-white'>
                        <div className='flex gap-3 items-end'>
                            ...
                            <div>
                                <h3 className='text-[#1B2530] text-xl font-medium pb-2'>Md Khalid</h3>
