...
const ErrorPage = () => {
    return (
        <div>
            <Navbar></Navbar>
            <div className='bg-[#F5F8F9] flex justify-center max-h-screen pt-40'>
                <div>
                    <h2 className="text-[150px] leading-[170px] text-[#686EF8] font-bold text-center">404</h2>
                    <h4 className='text-[#1B2530] text-center font-medium text-[36px] inter'>Sorry, the page can't be found</h4>
